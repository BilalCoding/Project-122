...
train_data = pd.read_csv("PRO-C122-Project-Boilerplate-main/static/assets/data_files/updated_product_dataset.csv")
training_sentences = []
...
model = load_model("PRO-C122-Project-Boilerplate-main/static/assets/model_files/sentiment_analysis_model.h5")
